"""
Django settings for AA_Main project.
...
SECRET_KEY = '91ua5fs-+v$=ec@!+6*wrrex#d62(4vndns5rf3#u@l^zft1lr'
...
MIDDLEWARE = [
    ...
    # Reading static files for Heroku:
...
WSGI_APPLICATION = 'AA_Main.wsgi.application'
